...
export async function handleCheckConnection(client: StrapiClient) {
...
export async function handleCheckDuplicate(client: StrapiClient, args: any) {
...
export async function handleGetCategories(client: StrapiClient, args: any) {
